...
class CategorySelectorHandlerWidget {
  ...
  static void openCategorySelector(
    ...
    CategorySelectorModal.show(
      ...
      onCategorySelected:
          (category) => _handleCategorySelection(
            context,
            category,
            categories,
            shouldNavigate:
                false, // No navegar cuando se selecciona desde el selector principal
          ),
    );
  }
  ...
  static void _handleCategorySelection(
    ...
    AppLogger.logInfo(
      'Categoría seleccionada: ${category.name}, navegación: $shouldNavigate',
    );
