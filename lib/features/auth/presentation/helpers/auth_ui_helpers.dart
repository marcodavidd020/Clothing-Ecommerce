...
class AuthUIHelpers {
  ...
  static Widget get smallVerticalSpace => const SizedBox(height: AppDimens.vSpace16);
  
  /// Construye un espacio vertical estándar mediano
  static Widget get mediumVerticalSpace => const SizedBox(height: AppDimens.vSpace32);
